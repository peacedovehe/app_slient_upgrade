...
public class SharedPreferencesHelper {
    private final String TAG = SharedPreferencesHelper.class.getSimpleName();
...
//            sPreferences = PreferenceManager.getDefaultSharedPreferences(context);
            sPreferences = context.getSharedPreferences("pref_name", Context.MODE_PRIVATE);
        }
    }
    ...
    public String getToken() {
        return sPreferences.getString("token", AppApiContact.INIT_TOKEN);
    }
    ...
    public String getUserId() {
        return sPreferences.getString("userId", "100032");
    }
...
//        return sPreferences.getBoolean(AppSpContact.FIRST_LOGIN, true);
//    }
//
//    public void setFirstLogin(boolean flag) {
//        SharedPreferences.Editor editor = sPreferences.edit();
//        putBoolean(AppSpContact.FIRST_LOGIN, flag);
//        editor.apply();
//    }
